    ...
    <header>
      <div  className="flex justify-between gap-10 container mx-auto py-7">
        ...
        <nav className="flex gap-44 font-medium">
          <Link href="#" className="relative after:content-[''] after:block after:rounded-full after:bg-primary after:h-[3px] after:w-1/2 after:left-1/2 after:-translate-x-1/2 after:translate-y-1 after:absolute ">Home</Link>
