    ...
    <CartWithHeader title="Order Information">
      <div className="p-5">
        ...
        <div className="input-group">
          ...
          <input type="text" placeholder="Type your whatsapp number" id="customerContact" name="customerContact" value={formData.customerContact!.toString()} onChange={handleInputChange}/>
        </div>
        <div className="input-group">
