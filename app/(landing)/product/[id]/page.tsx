  ...
  return (
    <main className="container mx-auto py-40 flex gap-12">
      <div className="bg-primary-light aspect-square min-w-140 flex justify-center items-center">
        <Image src="/images/products/product-4.svg" width={550} height={550} alt="Product 4 image" className="aspect-square object-contain w-full"/>
      </div>
      <div className="w-full py-7">
        <h1 className="font-bold text-5xl mb-6">SportOn HyperSoccer v2</h1>
        <div className="bg-primary-light text-primary py-2 px-6 rounded-full w-fit mb-5">Football</div>
